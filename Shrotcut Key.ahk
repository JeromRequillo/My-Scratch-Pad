...
The current sequence number is automatically saved to settings.ini after every hotkey press. Progress is never lost, even if the application is closed unexpectedly.
    ...
    mainGui.Add("Text", "x30 y120 w85 h20 +0x200", "")
    mainGui.Add("Text", "x118 y120 w180 h20", "")
...
v1.0  — 
    ...
    SaveSettings(*) {
        ...
        Loop LV.GetCount() {
            ...
            IniWrite(hTxt, "settings.ini", hkSection, hKey)
            IniWrite(isEnabled ? "1" : "0", "settings.ini", stSection, hKey)
